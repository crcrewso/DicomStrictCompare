...
namespace DicomStrictCompare.Model.Tests
{
    ...
    public class DoseMatrixOptimalTests
    {
        ...
        {
            var doseFile = DSCTests.Properties.Resources.RD_UnitTest_P1Ref_X_100A_10_0_1;
            var doseMatrix = new EvilDICOM.RT.DoseMatrix(EvilDICOM.Core.DICOMObject.Read(doseFile));
